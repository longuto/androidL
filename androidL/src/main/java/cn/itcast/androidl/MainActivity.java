...
import cn.itcast.androidl.fragment.BaseFragment;
import cn.itcast.androidl.fragment.FragmentFactory;


public class MainActivity extends Activity implements DrawerLayout.DrawerListener, DrawerFragment
    ...
    private void initActionBar() {
        ...
        //初始化开关，并和drawer关联
        mToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.string.navigation_drawer_open,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        return mToggle.onOptionsItemSelected(item) || mCurrentFragment.onOptionsItemSelected
