...
public class AnimationFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bt1:
                Animator animator1 = ViewAnimationUtils.createCircularReveal(bt1, bt1.getWidth()
                        / 2, bt1.getHeight() / 2, bt1.getWidth(), 0);
                animator1.setInterpolator(new LinearInterpolator());
                animator1.setDuration(1000);
                animator1.start();
                break;
            case R.id.bt2:
                Animator animator2 = ViewAnimationUtils.createCircularReveal(bt2, 0, bt2
                        .getHeight(), 0, (float) Math.hypot(bt2.getWidth(), bt2.getHeight()));
